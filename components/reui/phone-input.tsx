      ...
      <ComboboxTrigger
        render={
          <Button
            ...
            size={variant}
            className={cn(
              "rounded-s-md rounded-e-none shadow-xs shadow-black/5 flex gap-1 border-e-0 px-2.5 py-0 leading-none hover:bg-transparent focus:z-10 data-pressed:bg-transparent",
              disabled && "opacity-50"
            )}
            disabled={disabled}
          >
